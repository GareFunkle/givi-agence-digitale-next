    ...
    <section className="mt-[2rem] max-w-full">
      <div className="flex items-center flex-col  w-full">
        <div className="mb-[1.5rem]">
          <h2 className="bg-black text-[4rem]  font-bold text-white pl-[1rem] pr-[1rem] pt-[0.5rem] pb-[0.5rem] rounded-[calc(5rem/4)]">
        ...
        {itemsFaq.map((item) => (
          <div className="flex items-start justify-center  " key={item.id}>
            <div className="flex items-start justify-center flex-col mb-[1rem] mt-[1rem] w-[44%]">
              ...
              <hr
                className="w-[60%]   mt-[1rem] mb-[1rem] border-2 border-black"
                color="#000"
              />
