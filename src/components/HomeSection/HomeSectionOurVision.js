  ...
  return (
    <section className='  max-w-full  bg-dark-light text-white'>
      ...
      <div className='flex items-center justify-center pb-20 pt-28'>
        <Link
          href='#'
          className='group  relative overflow-hidden  rounded-[calc(5rem/6.2)] border-2  border-pink bg-transparent bg-white p-2 px-4 py-2  text-4xl font-bold text-black   shadow-[5px_5px_0px_0px_#ff00aa18]  transition-all duration-300 '
        >
