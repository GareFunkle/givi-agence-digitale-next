...
const OurVisionAgency = () => {
  return (
    <section className='flex items-center justify-center p-8'>
      <div className='mb-[3.5rem] flex w-[80%] flex-col justify-start'>
        <h2 className='mb-[1.3rem] text-[2.5rem]  font-bold'>
          L&#39;agence digitale GIVI
        </h2>
        <p className='mb-[1.2rem] text-[1.5rem] font-[500]'>
...
export default OurVisionAgency;
